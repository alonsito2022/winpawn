...
Partial Public Class Home
    ...
    End Sub
    Protected Overridable Sub SynchronizeBarAndDockingControllerWithDefault()
...
#Region "IActionControlsSite Members"
    Private ReadOnly Property IActionControlsSite_ActionControls() As IEnumerable(Of IActionControl) Implements IActionControlsSite.ActionControls
        Get
            Dim siteActionControls As New List(Of IActionControl)(barManager.ActionControls)
            Return siteActionControls
        End Get
    End Property
    Private ReadOnly Property ActionContainers() As IEnumerable(Of IActionControlContainer) Implements IActionControlsSite.ActionContainers
        Get
            Dim barsActionContainers As New List(Of IActionControlContainer)(barManager.ActionContainers)
            barsActionContainers.Add(sidePanelActionControlContainer)
            Return barsActionContainers
        End Get
    End Property
...
#Region "ISidePanelHolder Members"
    Private ReadOnly Property ISidePanelHolder_SidePanel() As SidePanel Implements ISidePanelHolder.SidePanel
        Get
            Return sidePanel
        End Get
    End Property
